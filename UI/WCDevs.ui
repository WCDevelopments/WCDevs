...
local function C_21()
    ...
    -- Wait for parents to exist
    while not (script.Parent and script.Parent.Parent and script.Parent.Parent.Parent and script.Parent.Parent.Parent.Parent and script.Parent.Parent.Parent.Parent.Parent and script.Parent.Parent.Parent.Parent.Parent.OpenButton and script.Parent.Parent.Parent.Parent.Parent.NathubUI) do
        task.wait()
    end
...
local function C_24()
    ...
    -- Wait for parents to exist
    while not (script.Parent and script.Parent.Parent and script.Parent.Parent.Parent and script.Parent.Parent.Parent.Parent and script.Parent.Parent.Parent.Parent.NathubUI and script.Parent.Parent.Topbar) do
        task.wait()
    end
...
local function C_89()
    ...
    -- Wait for parents to exist
    while not (script.Parent and script.Parent.Parent and script.Parent.Parent.OpenButton) do
        task.wait()
    end
    local UserInputService = game:GetService("UserInputService")
...
local function C_8c()
    ...
    -- Wait for parents to exist
    while not (script.Parent and script.Parent.Parent and script.Parent.Parent.Parent and script.Parent.Parent.Parent.OpenButton and script.Parent.Parent.Parent.NathubUI and script.Parent.Parent.Parent.NathubUI.Holder) do
        task.wait()
    end
...
local function C_8d()
    ...
    -- Wait for parents to exist
    while not (script.Parent and script.Parent.NathubUI and script.Parent.NathubUI.Holder and script.Parent.NathubUI.Holder.ContainerTab and script.Parent.NathubUI.Holder.ContainerTab.TabList and script.Parent.NathubUI.Holder.ContainerTab.TabList.ScrollingFrame and script.Parent.NathubUI.Holder.ContainerTab.TabList.ScrollingFrame.Button and script.Parent.NathubUI.Holder.ContainerElement and script.Parent.NathubUI.Holder.ContainerElement.Element) do
        task.wait()
    end
